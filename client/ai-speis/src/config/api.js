...
export const ENDPOINTS = {
  ...
  QUESTION_RETRY: `${API_BASE_URL}/api/question-retry`,
  SINGLE_QUESTION_INTERVIEW_EVALUATE: `${API_BASE_URL}/api/single-question-interview`,
  QUESTION_RETRY_HISTORY: (questionId) => `${API_BASE_URL}/api/question-retry/question/${questionId}`,
  ...
  ADMIN_QUESTIONS_TRASH: `${API_BASE_URL}/api/admin/questions/trash`,
  ...
  ADMIN_QUESTION_RESTORE: (id) => `${API_BASE_URL}/api/admin/questions/${id}/restore`,
  ADMIN_QUESTION_PURGE: (id) => `${API_BASE_URL}/api/admin/questions/${id}/purge`,
