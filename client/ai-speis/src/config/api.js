...
export const ENDPOINTS = {
  ...
  TECHNICAL_INTERVIEW_PRE_GENERATE: (sessionId) => `${API_BASE_URL}/api/technical-interviews/${sessionId}/pre-generate`,
  TECHNICAL_INTERVIEW_PRE_GENERATE_STATUS: (sessionId) => `${API_BASE_URL}/api/technical-interviews/${sessionId}/pre-generate-status`,
  TECHNICAL_INTERVIEW_CANCEL_PRE_GENERATE: (sessionId) => `${API_BASE_URL}/api/technical-interviews/${sessionId}/cancel-pre-generate`,
  ...
  TECHNICAL_V2_INTERVIEW_INITIALIZE: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/initialize`,
  TECHNICAL_V2_INTERVIEW_START: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/start`,
  TECHNICAL_V2_INTERVIEW_STATE: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/state`,
  TECHNICAL_V2_INTERVIEW_CURRENT_QUESTION: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/current-question`,
  TECHNICAL_V2_INTERVIEW_ANSWER: (sessionId, sessionQuestionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/questions/${sessionQuestionId}/answers`,
  TECHNICAL_V2_INTERVIEW_COMPLETE: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/complete`,
  TECHNICAL_V2_INTERVIEW_FEEDBACK: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/feedback`,
  TECHNICAL_V2_INTERVIEW_RESULT: (sessionId) => `${API_BASE_URL}/api/interviews/${sessionId}/technical/result`,
