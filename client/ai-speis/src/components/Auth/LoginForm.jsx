  ...
  return (
    <div className="w-full">
      <div className="text-center mb-5">
        <h1 className="text-[26px] font-bold text-text-primary mb-1">{t('title')}</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between mt-0.5 mb-1">
          ...
          <a href="#forgot-password" className="text-[13px] text-text-primary hover:text-primary transition-colors duration-200">
            {t('forgot_password')}
          </a>
        </div>
      ...
      <div className="relative flex items-center justify-center mt-4 mb-4">
        ...
        <span className="relative bg-surface-2 px-4 text-[12px] font-medium text-text-secondary uppercase tracking-wider">
          {t('or')}
        </span>
      </div>
      ...
      <div className="text-center">
        <span className="text-[13px] text-text-secondary">{t('no_account')} </span>
        <a href="#register" className="text-[13px] font-semibold text-text-primary underline hover:text-primary transition-colors duration-200">
          {t('sign_up')}
        </a>
      </div>
    </div>
