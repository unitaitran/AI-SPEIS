...
function TechnicalEvaluationState({ transcript, compact = false, finalizing = false, t }) {
  return (
    <section
    ...
    >
      ...
      <h2>{t(finalizing ? 'room.finalizingTitle' : 'room.evaluatingTitle')}</h2>
      <p>{t(finalizing ? 'room.finalizingDescription' : 'room.evaluatingDescription')}</p>
      {transcript && (
